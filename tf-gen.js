...
// docKeywords = [["sky","blue"],["sun","bright","today"],["sun","sky","bright"]];
let docKeywords = [];
...
// in length.txt, it stores cumulative length of each element in docKeywords
let sum = 0;
for (let i = 0; i < N; i++) {
...
// keywords = ["sky","blue","sun","bright","today"];  union of all keywords in each text file
let keywords = [];
for (let i = 0; i < N; i++) {
...
// TF is 2d array for term frequency
let TF = new Array(N);
for (let i = 0; i < N; i++) {
